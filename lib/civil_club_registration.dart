...
class Photography_Club_Registration extends StatefulWidget {

  const Photography_Club_Registration({super.key});

  @override
  State<Photography_Club_Registration> createState() => _Photography_Club_RegistrationState();
}

class _Photography_Club_RegistrationState extends State<Photography_Club_Registration> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Civil Engineering Club Registration",
