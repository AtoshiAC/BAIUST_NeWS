...
class LAW_Registration extends StatefulWidget {
  const LAW_Registration({super.key});

  @override
  State<LAW_Registration> createState() => _LAW_RegistrationState();
}

class _LAW_RegistrationState extends State<LAW_Registration> {
  @override
