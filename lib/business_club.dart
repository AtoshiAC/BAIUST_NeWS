...
import 'business_club_registration.dart';
import 'categories.dart';
import 'notification.dart';


class Business_Club extends StatefulWidget {
  const Business_Club({super.key});

  @override
  State<Business_Club> createState() => _Business_ClubState();
}

class _Business_ClubState extends State<Business_Club> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Image(
                height: 160,
                width: 160,
                image: AssetImage("images/business clun.png"),

              ),
              SizedBox(height: 20,),

              Text("BAIUST BUSINESS CLUB",
              ...
              TextButton(
                  ...
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Business_Club_Registration()));
                  },
