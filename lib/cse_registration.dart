...
class CSE_Registration extends StatefulWidget {
  const CSE_Registration({super.key});

  @override
  State<CSE_Registration> createState() => _CSE_RegistrationState();
}

class _CSE_RegistrationState extends State<CSE_Registration> {
  @override
