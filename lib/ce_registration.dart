...
class CE_Registration extends StatefulWidget {
  const CE_Registration({super.key});

  @override
  State<CE_Registration> createState() => _CE_RegistrationState();
}

class _CE_RegistrationState extends State<CE_Registration> {
  @override
