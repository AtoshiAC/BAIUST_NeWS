...
class Cultural_Club_Registration extends StatefulWidget {
  const Cultural_Club_Registration({super.key});

  @override
  State<Cultural_Club_Registration> createState() => _Cultural_Club_RegistrationState();
}

class _Cultural_Club_RegistrationState extends State<Cultural_Club_Registration> {
