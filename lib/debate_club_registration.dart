...
class Debate_Club_Registration extends StatefulWidget {

  const Debate_Club_Registration({super.key});

  @override
  State<Debate_Club_Registration> createState() => _Debate_Club_RegistrationState();
}

class _Debate_Club_RegistrationState extends State<Debate_Club_Registration> {
